            ...
            do{
                ...
                switch(user_input){
                    case 1:{
                        ...
                        switch(user_input){
                            ...
                            case 2:{
                                ...
                                user_input = input.nextInt();  
                                System.out.print(CustomerController.pay_theBill(Resultset_for_customer, tickets, user_input));
                                break;
                            }
                            default:{
                                 break;
                    ...
                    case 2:{
                        ...
                        if(AdminController.checkAccount(Resultset_for_admin, new Admins(adminName, adminPassword)) == true){
                                ...
                                case 2:{
                                    ...
                                    switch(user_input){
                                        case 1:{
                                            ...
                                            adminPassword = input.next();
                                            adminModification.addAdmin(Resultset_for_admin, admin, new Admins(adminName, adminPassword));
                                        ...
                                        case 2:{
                                            ...
                                            adminModification.updateAdminPassword(Resultset_for_admin, admin, new Admins(adminName, adminPassword));
                                        ...
                                        case 3:{
                                            ...
                                            adminModification.deleteAdmin(Resultset_for_admin, adminName);
                            ...
                            System.out.println("account is not existe");    
                        }
                        break;
                   }
