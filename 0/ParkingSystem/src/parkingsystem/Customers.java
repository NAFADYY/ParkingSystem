...
public class Customers extends Tickets {
        ...
        Customers(int id_of_ticket, String Plate_Number_of_car, int spot_number_in_parking, long phone_of_ticketOwner, Date date_of__entry) {
            ...
            this.setDate_of_entry(date_of__entry);
