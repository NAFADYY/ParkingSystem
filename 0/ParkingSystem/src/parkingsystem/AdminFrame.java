...
public class AdminFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(AdminController.checkAccount(Resultset_for_admin, new Admins(jTextField1.getText(), jTextField2.getText()))){
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        adminModification.addAdmin(Resultset_for_admin, admin, new Admins(jTextField3.getText(), jTextField4.getText()));
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        adminModification.updateAdminPassword(Resultset_for_admin, admin, new Admins(jTextField1.getText(), jTextField5.getText()));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        jPanel8.setVisible(false);
        jPanel9.setVisible(false);
        adminModification.deleteAdmin(Resultset_for_admin, jTextField6.getText());
